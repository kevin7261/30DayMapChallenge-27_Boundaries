# 🌍 30 Day Map Challenge - Day 14: Data challenge - OpenStreetMap
...
1. **克隆專案**
   ...
   cd website/30DayMapChallenge-14_Data-challenge-OpenStreetMap
   ```
...
3. **啟動開發服務器**
   ...
   瀏覽器訪問：`http://localhost:8080/30DayMapChallenge-14_Data-challenge-OpenStreetMap/`
